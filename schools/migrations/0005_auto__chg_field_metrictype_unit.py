...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MetricType.unit'
        db.alter_column(u'schools_metrictype', 'unit', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'MetricType.unit'
        db.alter_column(u'schools_metrictype', 'unit', self.gf('django.db.models.fields.CharField')(default='', max_length=10))
